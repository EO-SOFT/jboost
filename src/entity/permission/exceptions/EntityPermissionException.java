 ...
 * EntityPermissionException.java
 * 
...
public class EntityPermissionException extends Exception{
    ...
    public EntityPermissionException() {
    }
    ...
    public EntityPermissionException(String message, Throwable cause) {
        super(message, cause);
    }

    public EntityPermissionException(Throwable cause) {
        super(cause);
    }

    public EntityPermissionException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
