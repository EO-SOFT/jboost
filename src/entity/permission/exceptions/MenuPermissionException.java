 ...
 */
package entity.permission.exceptions;

/**
 *
 * @author OUSSAMA EZZIOURI <oussama.ezziouri@gmail.com>
 */
public class MenuPermissionException extends Exception {

    public MenuPermissionException() {
    }

    public MenuPermissionException(String message) {
        super(message);
    }

    public MenuPermissionException(String message, Throwable cause) {
        super(message, cause);
    }

    public MenuPermissionException(Throwable cause) {
        super(cause);
    }

    public MenuPermissionException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
